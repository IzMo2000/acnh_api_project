...
# this program allows villager databases from Animal Crossing: New Horizons to be searched from
# an ID number.
# uses ACNH API (v1)
###############################################################################################
...
while True:
  ...
  villager_num = int(input("\nEnter the villager number you would like to see the database for (1-391): "))
